...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    static ImVec4 rd = ImColor(1.000f, 0.0f, 0.000f, 1.000f);
    static ImVec4 blr = { 1.000f, 0.0f, 0.000f, 1.000f };
    ...
    if (*v)
    {
        ...
        else
        {
            ...
            window->DrawList->AddRectFilled(ImVec2(check_bb.Min.x + 0, check_bb.Min.y + 1), ImVec2(check_bb.Min.x + 17, check_bb.Min.y + 17), ImColor(0.158f, 0.992f, 0.000f, 1.000f), 4);
...
bool ImGui::SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags)
{
    ...
    const ImU32 frame_col = GetColorU32(g.ActiveId == id ? ImGuiCol_FrameBgActive : g.HoveredId == id ? ImGuiCol_FrameBgHovered : ImGuiCol_FrameBg);
    RenderNavHighlight(frame_bb, id);
    // window->DrawList->sliderline(ImVec2(frame_bb.Min.x, frame_bb.Min.y + 10), ImVec2(frame_bb.Max.x, frame_bb.Min.y + 10), ImColor(0.333f, 0.312f, 0.312f, 1.000f), 2.7f);
    // window->DrawList->sliderline(ImVec2(frame_bb.Min.x, frame_bb.Min.y + 10), ImVec2(grab_bb.Min.x, frame_bb.Min.y + 10), ImColor(255, 255, 0, 255), 2.7f);
    ...
    // (0, 251, 254, 255)
    window->DrawList->AddRectFilled(ImVec2(frame_bb.Min.x, frame_bb.Min.y + 8.9f), ImVec2(frame_bb.Max.x, frame_bb.Max.y - 8.5f), ImColor(36, 40, 40), 5);

    if (hovered || ImGui::IsItemActive())
    {
        window->DrawList->AddRectFilled(ImVec2(frame_bb.Min.x, frame_bb.Min.y + 8.9f), ImVec2(grab_bb.Min.x, frame_bb.Max.y - 8.5f), ImColor(255, 255, 0, 255), 5);

    }
    else
    {
        window->DrawList->AddRectFilled(ImVec2(frame_bb.Min.x, frame_bb.Min.y + 8.9f), ImVec2(grab_bb.Min.x, frame_bb.Max.y - 8.5f), ImColor(255, 0, 0, 255), 5);
...
//   (255, 255, 0, 255)
    ...
    if (hovered || ImGui::IsItemActive())
    {
        window->DrawList->AddCircleFilled(ImVec2(grab_bb.Min.x + 0.0f, grab_bb.Min.y + 10), 3.5f, ImColor(255, 255, 0, 255), 360);
    }
    else
    {
        window->DrawList->AddCircleFilled(ImVec2(grab_bb.Min.x + 0.0f, grab_bb.Min.y + 10), 3.5f, ImColor(255, 0, 0, 255), 360);
    }
    ...
    if (hovered || ImGui::IsItemActive())
    {
        RenderTextClipped(ImVec2(grab_bb.Min.x - 15, total_bb.Min.y - 15), ImVec2(grab_bb.Max.x + 10, total_bb.Min.y + 20), value_buf, value_buf_end, NULL, ImVec2(0.5f, 0.5f));
    }
...
bool ImGui::Hotkey(const char* label, int* k, const ImVec2& size_arg)
{
    ...
    char buf_display[64] = "Click for Bind Key";
...
bool    ImGui::BeginTabBarEx(ImGuiTabBar* tab_bar, const ImRect& tab_bar_bb, ImGuiTabBarFlags flags)
{
    ...
    // Draw separator
    const ImU32 col = GetColorU32(ImVec4(1.000f, 0.000f, 0.000f, 1.000f));
    const float y = tab_bar->BarRect.Max.y - 1.0f;
    {
        const float separator_min_x = tab_bar->BarRect.Min.x - IM_FLOOR(window->WindowPadding.x * 0.5f);
        const float separator_max_x = tab_bar->BarRect.Max.x + IM_FLOOR(window->WindowPadding.x * 0.5f);
        window->DrawList->AddLine(ImVec2(separator_min_x, y), ImVec2(separator_max_x, y), col, 1.99f);
    }
    return true;
}
...
bool ImGui::tab(const char* label, const char* icon, bool selected)
{
    ...
    ImVec2 pos = window->DC.CursorPos;
    ImVec2 size = ImGui::CalcItemSize(ImVec2(100, 27), label_size.x + style.FramePadding.x * 2.0f, label_size.y + style.FramePadding.y * 2.0f);
    ...
    static ImVec4 icoon = { 1.000f, 1.000f, 0.000f, 1.000f };
    static ImVec4 hov = { 0.231f, 1.000f, 0.000f, 1.000f };
    static ImVec4 inhov = { 1.000f, 1.0f, 1.000f, 1.000f };
    ...
    if (hovered || held)
    {
        ...
        ImGui::PushStyleColor(ImGuiCol_Text, (hovered || held) ? blr : inhov);

        ImGui::RenderText(ImVec2(bb.Min.x + 40, bb.Min.y + (size.y / 2) - (label_size.y / 2)), label);
        ImGui::PopStyleColor(1);


        ImGui::PushStyleColor(ImGuiCol_Text, (hovered || held) ? icoon : inhov);

        ImGui::PushFont(fon::iconfont);
        ImGui::RenderText(ImVec2(bb.Min.x + 20 - icon_size.x / 2, bb.Min.y + (size.y / 2) - (icon_size.y / 2)), icon);
        ImGui::PopFont();
        ImGui::PopStyleColor(1);
...
bool    ImGui::TabItemEx(ImGuiTabBar* tab_bar, const char* label, bool* p_open, ImGuiTabItemFlags flags)
{
    ...
    ImGui::PushStyleColor(ImGuiCol_Text, (held || hovered) ? hov : inhov);
