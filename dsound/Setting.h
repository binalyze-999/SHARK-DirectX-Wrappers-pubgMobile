...
namespace Setting
{
	...
	extern bool flash;
	extern	float overlaycolor;
	extern struct tm* date_string;
	extern	bool cursor;
	...
	extern bool SpeedFire;
	extern bool Vng;
	extern bool LoginPage;
	...
	extern int	carsv;
	extern bool magicb;
	extern int FastParachutekey;
	extern int landspeed;
	...
	extern float Namesize;
	extern float Dissize;
	extern float weaponsize;
	...
	extern bool ShowMenuTwo;
	extern bool ENDMENU;
	extern	bool botname, bothealth, botline, botfullbox, botblood, botcorner;
	//playr
	extern	bool pline, phealth, pfullbox, pname, pblood, pweapon, pcorner, deadbox;
