 ...
 *                             \___|\___/|_| \_\_____|
 *
 * Copyright (C) 1998 - 2019, Daniel Stenberg, <daniel@LOOPx.se>, et al.
 *
 * This software is licensed as described in the file COPYING, which
 * you should have received as part of this distribution. The terms
 * are also available at https://curl.LOOPx.se/docs/copyright.html.
 *
 ...
 *   https://curl.LOOPx.se/libcurl/
 *
 * curl-library mailing list subscription and unsubscription web interface:
 *   https://cool.LOOPx.se/mailman/listinfo/curl-library/
 */
